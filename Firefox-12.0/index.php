<?php
    ...
    $extensions = array(
        new extension(
            ...
            'https://addons.mozilla.org/firefox/downloads/file/150528/firebug-1.9.2-fx.xpi?src=external-Firebug-Swarm'
        ),
        new extension(
        ...
        new extension(
            ...
            array('designer'),
            'http://www.incaseofstairs.com/download/firediff/firediff1.1.4.xpi'
        ),
        new extension(
            ...
            array('performance'),
            'https://getfirebug.com/releases/netexport/netExport-0.8b21.xpi'
        ),
        new extension(
            ...
            array('developer'),
            'https://addons.mozilla.org/firefox/downloads/file/137007/firecookie-1.4-fx.xpi?src=external-Firebug-Swarm'
        ),
        new extension(
            ...
            array('developer'),
            'https://addons.mozilla.org/firefox/downloads/file/142699/illuminations_for_developers_for_firebug-1.1.11-fx.xpi?src=external-Firebug-Swarm'
        ),
        new extension(
            ...
            array('developer'),
            'http://getfirebug.com/releases/dojofirebugextension/1.8/dojofirebugextension-1.1.4.xpi'
        ),
        new extension(
            ...
            array('developer'),
            'https://addons.mozilla.org/firefox/downloads/file/144302/firephp-0.7.0-fx.xpi?src=external-Firebug-Swarm'
        ),
        new extension(
            'fbtest@mozilla.com',
            'FBTest',
            ...
            '',
            array('labs'),
            'http://getfirebug.com/releases/fbtest/1.9/fbTest-1.9b12.xpi'
        ),
        new extension(
            'info@cssUpdater.com',
            'cssUpdater',
            ...
            array('designer'),
            'https://addons.mozilla.org/firefox/downloads/file/143373/cssupdater-0.5.1-fx.xpi?src=external-Firebug-Swarm'
        )
    );
?>
<!DOCTYPE html>
